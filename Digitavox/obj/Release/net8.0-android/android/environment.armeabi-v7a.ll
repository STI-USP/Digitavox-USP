...
@dso_cache = dso_local local_unnamed_addr global [516 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 200676899, ; hash 0xbf61623, from name: Digitavox
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1425510424, ; hash 0x54f79018, from name: libaot-System.Speech
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1557308031, ; hash 0x5cd2a27f, from name: libaot-Digitavox
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 182
	%struct.DSOCacheEntry {
		i64 1618067638, ; hash 0x6071c0b6, from name: System.Speech
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 183
	...
	%struct.DSOCacheEntry {
		i64 2121038792, ; hash 0x7e6c7bc8, from name: System.Speech.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 250
	...
	%struct.DSOCacheEntry {
		i64 2173141745, ; hash 0x818782f1, from name: aot-Digitavox
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 259
	...
	%struct.DSOCacheEntry {
		i64 2290390280, ; hash 0x88849508, from name: Digitavox.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 276
	...
	%struct.DSOCacheEntry {
		i64 3502197769, ; hash 0xd0bf4c09, from name: aot-Digitavox.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 425
	...
	%struct.DSOCacheEntry {
		i64 3613311050, ; hash 0xd75ec04a, from name: libaot-System.Speech.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 438
	...
	%struct.DSOCacheEntry {
		i64 3780107757, ; hash 0xe14fdded, from name: aot-System.Speech.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 453
	...
	%struct.DSOCacheEntry {
		i64 3926749859, ; hash 0xea0d72a3, from name: aot-System.Speech
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 471
	...
	%struct.DSOCacheEntry {
		i64 3981738636, ; hash 0xed54828c, from name: libaot-Digitavox.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 480
