...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670861, ; uint32_t jnienv_initialize_method_token (0x6001d8d)
	i32 100670860, ; uint32_t jnienv_registerjninatives_method_token (0x6001d8c)
...
@dso_cache = dso_local local_unnamed_addr global [516 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 581594257571386759, ; hash 0x8123ce555f31587, from name: System.Speech.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.55_name, ; name: libaot-System.ComponentModel.EventBasedAsync.dll.so
		ptr null; void* handle (0x0)
	}, ; 17
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1634964691443162659, ; hash 0x16b08fb975c69e23, from name: Digitavox
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 41
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2891163434015012230, ; hash 0x281f79d340103586, from name: libaot-System.Speech.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 79
	...
	%struct.DSOCacheEntry {
		i64 4681792919110516103, ; hash 0x40f911dacf857d87, from name: libaot-Digitavox
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 126
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Plugin.Maui.Audio.dll.so
		ptr null; void* handle (0x0)
	}, ; 145
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6363321056817965282, ; hash 0x584f0ec96f65e8e2, from name: aot-System.Speech.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 156
	...
	%struct.DSOCacheEntry {
		i64 7264453924557298591, ; hash 0x64d0865b0c6e1b9f, from name: aot-System.Speech
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	...
	%struct.DSOCacheEntry {
		i64 10497767309912479810, ; hash 0x91af8fbfb20a9842, from name: System.Speech
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 286
	...
	%struct.DSOCacheEntry {
		i64 12620632622627302292, ; hash 0xaf257e80d8682b94, from name: libaot-System.Speech
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-System.Speech.dll.so
		ptr null; void* handle (0x0)
	}, ; 345
	...
	%struct.DSOCacheEntry {
		i64 12879633922254670857, ; hash 0xb2bda6d0250f8c09, from name: aot-Digitavox.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 354
	...
	%struct.DSOCacheEntry {
		i64 13397882200125402936, ; hash 0xb9eed6e04100ef38, from name: libaot-Digitavox.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 374
	...
	%struct.DSOCacheEntry {
		i64 16390212716733570700, ; hash 0xe375bba075fe9e8c, from name: Digitavox.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 459
	...
	%struct.DSOCacheEntry {
		i64 16834383226892873268, ; hash 0xe99fbe5a3bbe6e34, from name: aot-Digitavox
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digitavox.dll.so
		ptr null; void* handle (0x0)
	}, ; 475
...
@.env.3 = private unnamed_addr constant [37 x i8] c"69c3b38a-c467-4188-b8ee-b4b15f5fe9a6\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [21 x i8] c"br.usp.digitavox_USP\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-Digitavox.dll.so\00", align 16
...
@.DSOCacheEntry.22_name = private unnamed_addr constant [32 x i8] c"libaot-Plugin.Maui.Audio.dll.so\00", align 16
@.DSOCacheEntry.23_name = private unnamed_addr constant [28 x i8] c"libaot-System.Speech.dll.so\00", align 16
...
@.DSOCacheEntry.55_name = private unnamed_addr constant [52 x i8] c"libaot-System.ComponentModel.EventBasedAsync.dll.so\00", align 16
